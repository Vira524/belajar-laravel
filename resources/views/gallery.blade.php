        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="http://localhost:8000/beranda">Beranda
          ...
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_01.jpg')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_02.jpg')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_03.jpg')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_04.jpg')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_05.jpg')}}" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="{{ asset('style/assets/images/product_06.jpg')}}" alt="">
              </div>
            </div>
          </div>
        </div>
