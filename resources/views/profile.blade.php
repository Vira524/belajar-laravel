          ...
          <div class="col-md-6">
            <div class="left-content">
              ...
              <ul class="featured-list">
                <li><a href="#">Nama : Vira Febrianti</a></li>
                <li><a href="#">Kelas : XII RPL 1</a></li>
                <li><a href="#">No. Absen : 33</a></li>
                <li><a href="#">Sekolah : SMKN 1 Purwosari </a></li>
                <li><a href="#">No HP : 085748824104</a></li>
                <li><a href="#">Email : virafebrianti524@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
            <div class="right-image">
              <img src="{{ asset('style/assets/images/vira.jpg')}}" alt="">
            </div>
          </div>
        </div>
      </div>
